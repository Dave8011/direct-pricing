    ...
    <div class="cover-header">
      <div class="cover-top-bar" style="position: relative;">
        ...
        <div style="display: flex; flex-direction: column; align-items: flex-end;">
          ...
          <div style="font-size: 12.5px; font-weight: 800; color: #134226; text-align: right; margin-top: 8px; line-height: 1.3;">
            <div style="margin-bottom: 3px;">
              CALL OR WHATSAPP TO ORDER
            </div>
            <div style="font-size: 16.5px; display: flex; align-items: center; justify-content: flex-end; gap: 6px;">
